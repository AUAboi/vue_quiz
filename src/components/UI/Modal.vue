      ...
      >
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div
              class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-300 sm:mx-0 sm:h-10 sm:w-10"
            >
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          ...
          >
            <a href="https://auaboi.github.io/auaahsan/dist/">Portfolio</a>
          </button>
          <router-link
            to="/"
